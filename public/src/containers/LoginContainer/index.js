		...
		return (
			<form>
				<div className="form-unit">
					...
					<Input type="text" addonBefore={<Glyphicon glyph="user"/>} value={this.state.user} onChange={this.Change.bind(this)} name="user" ref="user" placeholder="用户名" aria-describedby="basic-addon1" />
					<Input type="password" addonBefore={<Glyphicon glyph="eye-open"/>} value={this.state.pass} onChange={this.Change.bind(this)} name="pass" ref="pass" placeholder="密码" aria-describedby="basic-addon1" />
					<div className="form-group form-submit">
						<a className="btn  btn-ghost" href="javascript:void(0)" onClick={this.onSubmit.bind(this)}>登录</a>
					</div>
